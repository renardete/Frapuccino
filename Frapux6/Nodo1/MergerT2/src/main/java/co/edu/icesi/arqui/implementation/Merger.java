...
import co.edu.icesi.arqui.interfaces.Merge2;
import co.edu.icesi.arqui.interfaces.Merge32;
import co.edu.icesi.arqui.interfaces.Merge31;
...
public class Merger implements Merge2{
	

	@Reference(name="sortIzq")
	private Merge31 sortIzq;

	@Reference(name="sortDer")
	private Merge32 sortDer;
