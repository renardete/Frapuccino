...
public class GeneradorDatos {
	...
	public static void main(String[] args) throws Exception{
		for(int i = 10000000; i<= 500000000; i+=2000000){
			generarDatos(i);
		}
	...
	public static void generarDatos(int numeroDatos) throws IOException {
		...
		int targetStringLength = 2; // La longitud de las palabras va a ser 60
		...
		File archivo = new File("Datos/datos_"+numeroDatos+".txt");
